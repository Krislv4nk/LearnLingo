    ...
    <div className={css.wrapper}>
      ...
      <nav className={css.nav}>
        <ul className={css.navList}>
          <ThemeProvider />
          <li>
            <Link className={css.link} to="/home" onClick={handleMenuItemClick}>
              Home
            </Link>
          </li>
          <li>
            <Link className={css.link} to="/teachers" onClick={handleMenuItemClick}>
              Teachers
            </Link>
          </li>
          {isSignIn ? (
            <li>
              <Link className={css.link} to="/favorites" onClick={handleMenuItemClick}>
                Favorites
              </Link>
            </li>
          ) : null}
        ...
        <div className={css.authBox}>
          ...
          <StyledEngineProvider injectFirst>
            <Dialog
              ...
              PaperComponent={() => (
                <LogOutModal onClose={closeModalHandler} isSignUp={isSignUp} onLogoutSuccess={handleLogoutSuccess} />
              )}
            />
