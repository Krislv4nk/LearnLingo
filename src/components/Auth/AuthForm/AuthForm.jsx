...
export const AuthForm = ({ onClose }) => {
  ...
  return (
    <div className={css.wrapper}>
      ...
      <p className={css.formInfo}>{isSignUp ? 'Thank you for your interest in our platform! In order to register, we need some information. Please provide us with the following information'
          ...
          <Form>
            {isSignUp && (
              <div>
                ...
                <Field type="text" id="name" name="name" className={css.field} placeholder="Name"/>
                <ErrorMessage name="name" component="div" />
              </div>
            )}
            <div>
              <label className={css.label} htmlFor="email">Email</label>
              <Field type="email" id="email" name="email" className={css.field} placeholder="Email"
            ...
            <div className={css.passwordContainer}>
              ...
              <Field type={lookPassword ? 'text' : 'password'} placeholder="Password" className={css.field} id="password" name="password"
              errors={errors ? errors.password : undefined}
                    touched={touched.password ? 'true' : 'false'}/>
              <button className={css.passwordBtn} onClick={passwordVisible}>
